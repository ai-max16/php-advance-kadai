...
// submitパラメータの値が存在するとき（「更新」ボタンを押したときの）処理
    ...
    <article class="registration">
      ...
      <form action="update.php?id=<?= $_GET['id'] ?>" method="post" class="registration-form">
        <div>
          ...
          <input type="number" name="book_code" value="<?= $product['book_code'] ?>" min="0" max="100000000" required>

          <label for="book_name">書籍名</label>
          <input type="text" name="book_name" value="<?= $product['book_name'] ?>" maxlength="50" required>
